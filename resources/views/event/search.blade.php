        ...
        <div class="col-12 mt-4">
          <div class="card mb-4">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-1">Your search <strong class="badge badge-sm bg-gradient-warning" > {{ $search }} : {{ count($events) }}  </strong></h6>
            </div>
            <div class="card-body p-3">
              <div class="row">
                ...
                @empty
                <strong class="alert alert-danger" style="color:white;">{{ "No event's title matches your search " }}</strong>
                @endforelse
